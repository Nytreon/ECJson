          ...
          "triggers": [
            ...
            },
            {
              "filters": {
                "all_of": [
                  { "test": "is_leashed", "subject": "self", "value": false },
                  { "test": "has_component", "subject": "self", "operator": "==", "value": "minecraft:persistent" }
                ]
              },
        ...
        "entity_types": [
          {
            "filters": {
              "all_of": [
                ...
                { "test": "has_component", "subject": "other", "operator": "not", "value": "minecraft:is_tamed" }
              ]
            },
            "max_dist": 10
          }
      ...
      "minecraft:damage_sensor": {
        "triggers": {
          ...
          "on_damage": {
            "filters": {
              "all_of": [
                { "test": "is_family", "subject": "other", "operator": "!=", "value": "trader_llama" },
