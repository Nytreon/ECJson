          ...
          "interactions": [
            {
              "on_interact": {
                "filters": {
                  "all_of": [
                    { "test": "has_equipment_tag", "subject": "self", "domain": "inventory", "operator": "not", "value": "minecraft:horse_armor" },
                    { "test": "has_equipment_tag", "subject": "player", "domain": "hand", "value": "minecraft:horse_armor" },
              ...
              "on_interact": {
                "filters": {
                  "all_of": [
                    ...
                    { "test": "has_equipment_tag", "subject": "self", "domain": "inventory", "value": "minecraft:horse_armor" },
